...
foreach(required_variable IN ITEMS
        ...
        CHANNEL_RAYD_SOURCE_DIR
        CHANNEL_RAYD_SOURCE_KIND
        CHANNEL_EXPECTED_RAYD_SHA
        CHANNEL_EXPECTED_RAYD_DIRTY
        CHANNEL_EXPECTED_RAYD_REMOTE
        CHANNEL_RAYD_ABI_FILE
        CHANNEL_EXPECTED_RAYD_ABI_SHA256
        CHANNEL_RAYD_LOCK_FILE
        CHANNEL_EXPECTED_RAYD_LOCK_SHA256
...
function(validate_git_checkout
    ...
    if(CHANNEL_RELEASE_BUILD AND actual_dirty)
...
if(CHANNEL_RAYD_SOURCE_KIND STREQUAL "git-checkout")
    ...
    if(NOT actual_rayd_remote STREQUAL CHANNEL_EXPECTED_RAYD_REMOTE)
        message(FATAL_ERROR
...
elseif(CHANNEL_RAYD_SOURCE_KIND STREQUAL "python-package")
    execute_process(
        COMMAND
            ...
            --expected-source "${CHANNEL_RAYD_SOURCE_DIR}"
