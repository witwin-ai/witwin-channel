...
py::tuple diffraction_paths_order1_forward_op(int64_t, at::Tensor, at::Tensor, OptionalTensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, int64_t, int64_t, double);
...
at::Tensor diffraction_discover_edges_op(at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor);
at::Tensor diffraction_discover_edges_counted_op(at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor);
...
TORCH_LIBRARY_FRAGMENT(raydn, m) {
    ...
    m.def("reflection_accumulation_forward(" RAYDN_SCHEMA_SCENE " scene, Tensor ray_o, Tensor ray_d, Tensor ray_tmax, Tensor active, Tensor tx, Tensor tx_pol, Tensor material_eta_r, Tensor material_sigma, Tensor material_mu_r, Tensor material_gain, Tensor material_valid, int max_bounces, int grid_axis, float grid_position, float grid_coord0_min, float grid_coord0_max, float grid_coord1_min, float grid_coord1_max, int grid_resolution0, int grid_resolution1, float wavelength, float solid_angle_per_ray, bool collect_wedges=False, bool collect_wedge_prefixes=False, int wedge_capacity=0, int wedge_sample_stride=1, int accumulation_strategy=0, int compact_min_samples=262144, int staged_min_samples_per_cell=64, int procedural_sample_count=0, bool streaming_los_enabled=False) -> Tensor?[]");
    ...
    m.def("diffraction_discover_edges(Tensor tx_pos, Tensor ray_dir, Tensor prim_index, Tensor hit_p, Tensor hit_n, Tensor hit_geo_n, Tensor triangle_edge_count, Tensor triangle_edge_indices, Tensor edge_pos, Tensor edge_dir, Tensor edge_n0, Tensor edge_nn, Tensor edge_line_min, Tensor edge_line_max, Tensor edge_adjacent_face1) -> Tensor");
    m.def("diffraction_discover_edges_counted(Tensor tx_pos, Tensor ray_dir, Tensor prim_index, Tensor hit_p, Tensor hit_n, Tensor hit_geo_n, Tensor hit_count, Tensor triangle_edge_count, Tensor triangle_edge_indices, Tensor edge_pos, Tensor edge_dir, Tensor edge_n0, Tensor edge_nn, Tensor edge_line_min, Tensor edge_line_max, Tensor edge_adjacent_face1) -> Tensor");
...
TORCH_LIBRARY_IMPL(raydn, CUDA, m) {
    ...
    m.impl("diffraction_discover_edges", TORCH_FN(diffraction_discover_edges_op));
    m.impl("diffraction_discover_edges_counted", TORCH_FN(diffraction_discover_edges_counted_op));
