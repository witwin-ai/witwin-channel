...
pybind11::dict channel_deterministic_diffraction_order1_compact(
    ...
    torch::Tensor z_im,
    torch::Tensor interaction_position);
pybind11::dict channel_deterministic_diffraction_order1_capacity_block(
    torch::Tensor failure_state,
    torch::Tensor count,
    torch::Tensor valid,
    torch::Tensor rx_id,
...
pybind11::dict channel_coupled_candidate_capacity_block(
    torch::Tensor failure_state,
...
pybind11::dict channel_evaluated_paths_canonical_capacity_gather(
    ...
    int64_t num_tx,
    int64_t num_rx);
pybind11::dict channel_evaluated_paths_canonical_capacity_gather_backward(
    torch::Tensor failure_state,
    torch::Tensor valid,
    torch::Tensor selected_row_index,
    std::optional<torch::Tensor> grad_path_length_m,
    ...
    int64_t sequence_width);
pybind11::dict channel_evaluated_paths_canonical_capacity_gather_jvp(
    torch::Tensor failure_state,
    torch::Tensor valid,
    torch::Tensor selected_row_index,
...
void register_path_diffraction_state(pybind11::module_ &module) {
    ...
    module.def(
        ...
        &channel_deterministic_diffraction_state_capacity_select,
...
void register_path_deterministic(pybind11::module_ &module) {
    ...
    module.def(
        ...
        &channel_deterministic_reflection_candidate_capacity_block,
    ...
    module.def(
        ...
        &channel_deterministic_diffraction_order1_capacity_block,
    ...
    module.def(
        ...
        &channel_coupled_candidate_capacity_block,
    ...
    module.def(
        ...
        &channel_enumerated_canonical_capacity_select,
    ...
    module.def(
        ...
        &channel_evaluated_paths_canonical_capacity_gather,
    ...
    module.def(
        ...
        &channel_evaluated_paths_canonical_capacity_gather_backward,
    ...
    module.def(
        ...
        &channel_deterministic_path_table_capacity_pack,
    ...
    module.def(
        ...
        &channel_deterministic_path_table_capacity_pack_backward,
    ...
    module.def(
        ...
        &channel_deterministic_path_table_capacity_pack_jvp,
    ...
    module.def(
        ...
        &channel_deterministic_diffraction_pair_reduce,
    ...
    module.def(
        ...
        &channel_deterministic_diffraction_pair_reduce_backward,
    ...
    module.def(
        ...
        &channel_deterministic_diffraction_pair_reduce_jvp,
    ...
    module.def(
        ...
        &channel_path_result_capacity_pack,
