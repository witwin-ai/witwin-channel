...
pybind11::tuple channel_rayd_intersect_forward(
    ...
    int64_t flags);
pybind11::tuple channel_rayd_visibility_forward(
    RayDSceneResource &scene,
    torch::Tensor start,
    torch::Tensor end,
    pybind11::object active);
pybind11::tuple channel_rayd_segment_penetration_forward(
    RayDSceneResource &scene,
    ...
    int64_t failure_bit);
pybind11::tuple channel_rayd_segment_penetration_forward_tape(
    RayDSceneResource &scene,
    torch::Tensor origins,
    torch::Tensor targets,
    pybind11::object input_active,
    ...
    torch::Tensor capacity_failure_state,
    int64_t failure_bit);
pybind11::tuple channel_rayd_segment_penetration_backward(
    RayDSceneResource &scene,
    torch::Tensor origins,
    torch::Tensor targets,
    pybind11::object input_active,
...
pybind11::tuple channel_rayd_segment_penetration_jvp(
    RayDSceneResource &scene,
    torch::Tensor origins,
    torch::Tensor targets,
    pybind11::object input_active,
...
pybind11::tuple channel_rayd_trace_reflections_forward(
    RayDSceneResource &scene,
    torch::Tensor ray_o,
    torch::Tensor ray_d,
    torch::Tensor ray_tmax,
    pybind11::object active,
    int64_t max_bounces);
pybind11::tuple channel_rayd_reflection_epc_paths_forward(
    RayDSceneResource &scene,
    torch::Tensor source,
...
pybind11::tuple channel_rayd_intersect_backward(
    RayDSceneResource &scene,
    torch::Tensor ray_o,
    torch::Tensor ray_d,
    torch::Tensor ray_tmax,
...
pybind11::tuple channel_rayd_intersect_jvp(
    RayDSceneResource &scene,
    torch::Tensor ray_o,
    torch::Tensor ray_d,
    pybind11::object active,
    ...
    int64_t flags);
pybind11::tuple channel_rayd_trace_reflections_forward_tape(
    RayDSceneResource &scene,
    torch::Tensor ray_o,
    torch::Tensor ray_d,
    torch::Tensor ray_tmax,
    pybind11::object active,
    int64_t max_bounces);
pybind11::tuple channel_rayd_trace_reflections_backward(
    RayDSceneResource &scene,
    torch::Tensor ray_o,
    torch::Tensor ray_d,
    torch::Tensor ray_tmax,
...
pybind11::tuple channel_rayd_trace_reflections_jvp(
    RayDSceneResource &scene,
    torch::Tensor ray_o,
    torch::Tensor ray_d,
    pybind11::object active,
    ...
    pybind11::object tangent_ray_d,
    torch::Tensor image_sources);
pybind11::tuple channel_rayd_reflection_epc_paths_backward(
    RayDSceneResource &scene,
    torch::Tensor source,
    torch::Tensor receiver,
...
pybind11::tuple channel_rayd_reflection_epc_paths_jvp(
    RayDSceneResource &scene,
    torch::Tensor source,
    torch::Tensor receiver,
    torch::Tensor sequence,
...
at::Tensor channel_rayd_scene_face_normals_backward(
    RayDSceneResource &scene,
    torch::Tensor grad_face_normals);
at::Tensor channel_rayd_scene_face_normals_jvp(
    RayDSceneResource &scene,
    torch::Tensor tangent_vertices);
pybind11::dict channel_coupled_rd_geometry_forward(
    RayDSceneResource &scene,
    torch::Tensor source,
    torch::Tensor receiver,
    ...
    torch::Tensor surface_group_members,
    bool reverse);
pybind11::dict channel_coupled_dd_geometry_forward(
    RayDSceneResource &scene,
    torch::Tensor source,
    torch::Tensor receiver,
...
pybind11::tuple channel_rayd_diffraction_paths_order1_forward(
    RayDSceneResource &scene,
    torch::Tensor tx_pos,
    torch::Tensor tx_pol,
    torch::Tensor rx_pos,
...
pybind11::tuple channel_rayd_diffraction_sample_tape_forward(
    RayDSceneResource &scene,
    pybind11::object active,
    torch::Tensor state_edge_index,
    torch::Tensor state_edge_pos,
...
at::Tensor channel_diffraction_tx_visible_state_plan(
    RayDSceneResource &scene,
    torch::Tensor tx,
