...
#define CHANNEL_REFLECTION_PREPARE_LAUNCH_INPUTS()                                         \
...
#define CHANNEL_REFLECTION_LAUNCH_INPUT_PREFIX()                                            \
...
#undef CHANNEL_REFLECTION_LAUNCH_INPUT_PREFIX
#undef CHANNEL_REFLECTION_PREPARE_LAUNCH_INPUTS
