...
pybind11::dict cn_bdpt_accumulate_connection_samples_backward(
    ...
    bool need_grad_contribution,
    bool need_grad_coeff) {
    return cn_bdpt_accumulate_connection_samples_backward_cuda(
        tensor_from_dict(samples, "mis_weight"),
        tensor_from_dict(samples, "tx_id"),
        tensor_from_dict(samples, "rx_id"),
        tensor_from_dict(samples, "component_id"),
...
pybind11::dict cn_bdpt_accumulate_connection_samples_jvp(
    ...
    pybind11::object scattering_re,
    pybind11::object scattering_im) {
    return cn_bdpt_accumulate_connection_samples_jvp_cuda(
        tensor_from_dict(samples, "mis_weight"),
        tensor_from_dict(samples, "tx_id"),
        tensor_from_dict(samples, "rx_id"),
        tensor_from_dict(samples, "component_id"),
...
pybind11::dict cn_bdpt_finalize_point_components_backward(
    at::Tensor los,
    pybind11::object grad_path_gain,
...
pybind11::dict cn_bdpt_finalize_point_components_jvp(
    at::Tensor los,
...
pybind11::dict cn_bdpt_finalize_component_maps_backward(
    at::Tensor los,
    pybind11::object grad_path_gain,
    pybind11::object grad_los_power,
    pybind11::object grad_reflection_power,
    ...
    pybind11::object grad_scattering_power,
    bool need_grad_components);
pybind11::dict cn_bdpt_finalize_component_maps_jvp(
    at::Tensor los,
    pybind11::object tangent_los,
    pybind11::object tangent_reflection,
    pybind11::object tangent_diffraction,
...
pybind11::dict cn_bdpt_reflected_light_subpath_state_backward_dispatch(
    ...
    return cn_bdpt_reflected_light_subpath_state_backward(
        tensor_from_dict(light, "direction"),
        tensor_from_dict(light, "throughput_real"),
        tensor_from_dict(light, "throughput_imag"),
        tensor_from_dict(light, "valid"),
...
pybind11::dict cn_bdpt_reflected_light_subpath_state_jvp_dispatch(
    ...
    return cn_bdpt_reflected_light_subpath_state_jvp(
        tensor_from_dict(light, "direction"),
        tensor_from_dict(light, "throughput_real"),
        tensor_from_dict(light, "throughput_imag"),
        tensor_from_dict(light, "valid"),
...
pybind11::dict cn_bdpt_transmitted_light_subpath_state_backward_dispatch(
    ...
    bool need_grad_field_in,
    bool need_grad_frequency) {
    return cn_bdpt_transmitted_light_subpath_state_backward(
        tensor_from_dict(light, "direction"),
        tensor_from_dict(light, "throughput_real"),
        tensor_from_dict(light, "throughput_imag"),
        tensor_from_dict(light, "valid"),
...
pybind11::dict cn_bdpt_transmitted_light_subpath_state_jvp_dispatch(
    ...
    pybind11::object tangent_light_throughput_real,
    pybind11::object tangent_light_throughput_imag) {
    return cn_bdpt_transmitted_light_subpath_state_jvp(
        tensor_from_dict(light, "direction"),
        tensor_from_dict(light, "throughput_real"),
        tensor_from_dict(light, "throughput_imag"),
        tensor_from_dict(light, "valid"),
...
pybind11::dict cn_bdpt_endpoint_connection_samples_backward_dispatch(
    ...
    return cn_bdpt_endpoint_connection_samples_backward_cuda(
        light_origin,
        tensor_from_dict(light, "direction"),
        tensor_from_dict(light, "field_real"),
        tensor_from_dict(light, "field_imag"),
...
pybind11::dict cn_bdpt_endpoint_connection_samples_jvp_dispatch(
    ...
    at::Tensor light_origin = tensor_from_dict(light, "origin");
    const int64_t tx_count = light_origin.size(0);
    return cn_bdpt_endpoint_connection_samples_jvp_cuda(
        light_origin,
        tensor_from_dict(light, "direction"),
        tensor_from_dict(light, "field_real"),
        tensor_from_dict(light, "field_imag"),
...
pybind11::dict cn_bdpt_finalize_point_components_backward_dispatch(
    ...
    (void)transmission;
    (void)scattering;
    return cn_bdpt_finalize_point_components_backward(
        los,
        std::move(grad_path_gain),
...
pybind11::dict cn_bdpt_finalize_point_components_jvp_dispatch(
    ...
    (void)transmission;
    (void)scattering;
    return cn_bdpt_finalize_point_components_jvp(
        los,
...
pybind11::dict cn_bdpt_finalize_component_maps_backward_dispatch(
    ...
    (void)transmission;
    (void)scattering;
    return cn_bdpt_finalize_component_maps_backward(
        los,
        std::move(grad_path_gain),
        std::move(grad_los_power),
        std::move(grad_reflection_power),
...
pybind11::dict cn_bdpt_finalize_component_maps_jvp_dispatch(
    ...
    (void)transmission;
    (void)scattering;
    return cn_bdpt_finalize_component_maps_jvp(
        los,
        std::move(tangent_los),
        std::move(tangent_reflection),
        std::move(tangent_diffraction),
