...
pybind11::dict cn_deterministic_reflection_candidate_capacity_block(
    ...
    channel_native::check_tensor(epc_hits, "epc_hits", at::kFloat, 3);
    channel_native::check_tensor(epc_normals, "epc_normals", at::kFloat, 3);
    channel_native::check_tensor(sequence_batch, "sequence_batch", at::kInt, 2);
    channel_native::check_tensor(rx_indices, "rx_indices", at::kInt, 1);
    channel_native::check_tensor(tx, "tx", at::kFloat, 1);
    channel_native::check_vec3_table(rx_positions, "rx_positions");
    channel_native::check_tensor(tx_power, "tx_power", at::kFloat, 1);
    channel_native::check_tensor(face_eps_r, "face_eps_r", at::kFloat, 1);
    channel_native::check_tensor(face_sigma_e, "face_sigma_e", at::kFloat, 1);
    channel_native::check_tensor(face_mu_r, "face_mu_r", at::kFloat, 1);
    channel_native::check_tensor(face_gain, "face_gain", at::kFloat, 1);
