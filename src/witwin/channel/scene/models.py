...
from witwin.channel.core.antenna import AntennaArray, AntennaPattern, orientation_matrix
...
class Scene:
    ...
    def load_mitsuba(cls, filename: str, **kwargs) -> Scene:
        from witwin.channel.scene.loader import load_mitsuba
    ...
    def diffraction_edge_count(self, edge_policy: EdgePolicy | None = None) -> int:
        from witwin.channel.core.edge_policy import DEFAULT_EDGE_POLICY
    ...
    def compile(self) -> CompiledScene:
        from witwin.channel.scene.compile import compile_scene
...
Material.__module__ = "witwin.channel.core.objects"
planar_uv.__module__ = "witwin.channel.core.objects"
Structure.__module__ = "witwin.channel.core.objects"
Transmitter.__module__ = "witwin.channel.core.objects"
ReceiverPoint.__module__ = "witwin.channel.core.objects"
ReceiverGrid.__module__ = "witwin.channel.core.objects"
Scene.__module__ = "witwin.channel.core.scene"
