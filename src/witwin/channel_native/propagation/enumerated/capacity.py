...
class _EvaluatedPathsCapacityPackFunction(torch.autograd.Function):
    ...
    def backward(ctx, *grad_outputs):
        ...
        raw = _required_native_op("evaluated_paths_capacity_pack_backward")(
            valid,
            selected_row_index,
            *continuous_grads,
            ctx.candidate_count,
    ...
    def jvp(ctx, *tangents):
        ...
        with torch_compat.disable_functorch():
            raw = _required_native_op("evaluated_paths_capacity_pack_jvp")(
                valid,
                selected_row_index,
                *continuous_tangents,
                ctx.candidate_count,
...
__all__ = ["evaluated_paths_capacity_pack"]
