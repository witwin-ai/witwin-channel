...
_NativeMesh.__module__ = "witwin.channel_native.core.scene_loader"
itu_material_parameters.__module__ = "witwin.channel_native.core.scene_loader"
load_mitsuba.__module__ = "witwin.channel_native.core.scene_loader"
