...
def _install_route_replay(
    ...
    matches = {
        ("base", "incident_te_tm_fractions"): [
            "src/witwin/channel_native/montecarlo/events/transmission.py:129:def incident_te_tm_fractions("
        ],
        ("candidate", "incident_te_tm_fractions"): [],
        ("base", "straight_transmission_chains"): [
            "src/witwin/channel_native/montecarlo/events/transmission.py:185:def straight_transmission_chains("
        ],
        ("candidate", "straight_transmission_chains"): (
            [
                "src/witwin/channel_native/montecarlo/events/transmission.py:150:def straight_transmission_chains("
            ]
        ...
        ("candidate", "MonteCarloTargetInset"): [
            "src/witwin/channel_native/montecarlo/events/transmission.py:212:    policy=MonteCarloTargetInset,"
        ],
    }
