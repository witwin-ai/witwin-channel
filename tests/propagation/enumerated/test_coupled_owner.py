...
_LEGACY_DIGESTS = {
    ...
    "export_topology": (
        "18e02bffb35b3a80fa2c474fb546d82b4742088ce65ad5de8ca4b8225b00de3c"
    ),
}
...
def test_transmission_and_export_call_order_remain_frozen():
    for name, digest in _LEGACY_DIGESTS.items():
        assert _digest(legacy, name) == digest
