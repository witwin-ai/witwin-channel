...
// lineage and lineage replay data are handled in Python alongside the packed
...
constexpr int PF_F0_MU_R           = 61;
constexpr int PF_F0_SIGMA          = 62;
constexpr int PF_F0_GAIN           = 63;
constexpr int PF_F0_USE_FRESNEL    = 64;
constexpr int PF_F1_ETA_R          = 65;
constexpr int PF_F1_MU_R           = 66;
constexpr int PF_F1_SIGMA          = 67;
constexpr int PF_F1_GAIN           = 68;
constexpr int PF_F1_USE_FRESNEL    = 69;
constexpr int PF_PREFIX_REFL_DEPTH = 70;
constexpr int PF_INTER_REFL_DEPTH  = 71;
constexpr int PF_SUFFIX_REFL_DEPTH = 72;
constexpr int PF_ORDER             = 73;

constexpr int PACKED_CORE_FLOATS   = 74;
...
constexpr int PSP_F0_MU_R                 = 61;
constexpr int PSP_F0_SIGMA                = 62;
constexpr int PSP_F0_GAIN                 = 63;
constexpr int PSP_F0_USE_FRESNEL          = 64;
constexpr int PSP_F1_ETA_R                = 65;
constexpr int PSP_F1_MU_R                 = 66;
constexpr int PSP_F1_SIGMA                = 67;
constexpr int PSP_F1_GAIN                 = 68;
constexpr int PSP_F1_USE_FRESNEL          = 69;
constexpr int PSP_PREFIX_REFL_DEPTH       = 70;
constexpr int PSP_INTER_REFL_DEPTH        = 71;
constexpr int PSP_SUFFIX_REFL_DEPTH       = 72;
constexpr int PSP_ORDER                   = 73;
constexpr int PACKED_CORE_POINTER_COUNT   = 74;
