...
from witwin.channel.core.numerics.arrays import complex_abs_sqr, complex_zero
...
def accumulate_reflected_segment_fields_chunk(
    ...
    if suffix_dda_inputs_require_native_ad(
        ...
        raise RuntimeError(
            "Dr.Jit suffix backend only supports non-differentiable suffix inputs. "
